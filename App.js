    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.depositContainer}>
          <Pressable style={styles.depositBtn} onPress={() => fazerDeposito(25)}>
            <Text style={styles.buttonText}>R$25</Text>
          </Pressable>

          <Pressable style={styles.depositBtn} onPress={() => fazerDeposito(50)}>
            <Text style={styles.buttonText}>R$50</Text>
          </Pressable>

          <Pressable style={styles.depositBtn} onPress={() => fazerDeposito(100)}>
